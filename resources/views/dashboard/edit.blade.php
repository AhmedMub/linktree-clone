        ...
        {!! Form::open(['class'=>'update-link-form', 'method'=>'PUT']) !!}
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        {!! Form::text('name', null, ['class'=>'form-control inv-name-msg form-edit-name', 'placeholder'=>'Enter Name']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('link', null,['class'=>'form-control inv-link-msg form-edit-link','placeholder'=>'Enter URL, Example: https://www.youtube.com/yourchannel']) !!}
                        <span class="invalid-feedback" role="alert">
